  ...
  return (
    <div className="CoffeeInfo">
      <ul>
        <li>
          <span>Brewed </span>
          <Moment calendar={calendarStrings}>{brewedAt}</Moment>
        </li>
        <li>
          <span>Time </span>
          <Moment format="hh:mm[h]">{brewedAt}</Moment>
        </li>
        <li>
          <span>Liters brewed </span>
          {litersBrewed}
        </li>
        <li>
          <span>Type of coffee </span>
          {typeOfCoffee}
        </li>
        <li>
          <span>Coffee left </span>
          {coffeeLeft}
        </li>
        <li>
          <span>Status </span>
